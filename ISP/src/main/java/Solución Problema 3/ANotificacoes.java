...
public class ANotificacoes extends Apresentacao implements IApresentacaoNotificacoes {
    /**
    ...
    public String notificacaoTransportadora(String encCode, String userCode,boolean aceite) {
        if(aceite)
            return notificacaoTransportadoraAceite(encCode, userCode);
        else
            return notificacaoTransportadoraRecusada(encCode, userCode);
    }
